namespace SabraForSpareParts.Screens
{
    partial class ucInventory
    {
        ...
        private void InitializeComponent()
        {
            ...
            sabraTableLayoutPanel1.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 8.333333F));
            sabraTableLayoutPanel1.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 8.333333F));
            sabraTableLayoutPanel1.Controls.Add(spnlDataGridViewOPtions, 0, 2);
            sabraTableLayoutPanel1.Controls.Add(sabraDataGridView1, 0, 3);
            sabraTableLayoutPanel1.Controls.Add(pnlUnpaidInvoices, 0, 1);
            sabraTableLayoutPanel1.Controls.Add(sabraPanel1, 1, 1);
            sabraTableLayoutPanel1.Controls.Add(pnlLowStock, 2, 1);
            sabraTableLayoutPanel1.Controls.Add(pnlNetProfit, 3, 1);
            sabraTableLayoutPanel1.Controls.Add(pnlSales, 4, 1);
            ...
            spnlDataGridViewOPtions.Controls.Add(cmbInventoryStatus);
            spnlDataGridViewOPtions.Controls.Add(scbxBrand);
            spnlDataGridViewOPtions.Controls.Add(scbxClassification);
            spnlDataGridViewOPtions.Controls.Add(stxbxSearch);
            ...
            lblTotalParts.TextAlign = ContentAlignment.MiddleRight;
            // 
            // icnUnpaidInvoices
            // 
            icnUnpaidInvoices.BackColor = Color.Transparent;
            icnUnpaidInvoices.Flip = FontAwesome.Sharp.FlipOrientation.Horizontal;
            icnUnpaidInvoices.ForeColor = SystemColors.ActiveBorder;
            icnUnpaidInvoices.IconChar = FontAwesome.Sharp.IconChar.PuzzlePiece;
            icnUnpaidInvoices.IconColor = SystemColors.ActiveBorder;
            icnUnpaidInvoices.IconFont = FontAwesome.Sharp.IconFont.Auto;
            icnUnpaidInvoices.IconSize = 61;
            icnUnpaidInvoices.Location = new Point(141, 9);
            icnUnpaidInvoices.Name = "icnUnpaidInvoices";
            icnUnpaidInvoices.Size = new Size(61, 74);
            ...
            sabraPanel1.Controls.Add(iconPictureBox2);
            sabraPanel1.Dock = DockStyle.Fill;
            ...
            sabraPanel1.Location = new Point(1081, 165);
            sabraPanel1.Margin = new Padding(15);
            sabraPanel1.Name = "sabraPanel1";
            sabraPanel1.Size = new Size(226, 90);
            ...
            lblLowStock.TextAlign = ContentAlignment.MiddleRight;
            // 
            // iconPictureBox2
            // 
            iconPictureBox2.BackColor = Color.Transparent;
            iconPictureBox2.ForeColor = Color.Firebrick;
            iconPictureBox2.IconChar = FontAwesome.Sharp.IconChar.LongArrowDown;
            iconPictureBox2.IconColor = Color.Firebrick;
            iconPictureBox2.IconFont = FontAwesome.Sharp.IconFont.Auto;
            iconPictureBox2.IconSize = 63;
            iconPictureBox2.Location = new Point(151, 10);
            iconPictureBox2.Name = "iconPictureBox2";
            iconPictureBox2.Size = new Size(63, 70);
            ...
            pnlLowStock.Location = new Point(825, 165);
            pnlLowStock.Margin = new Padding(15);
            pnlLowStock.Name = "pnlLowStock";
            pnlLowStock.Size = new Size(226, 90);
            pnlLowStock.TabIndex = 8;
            // 
            ...
            lblZeroStock.TextAlign = ContentAlignment.MiddleRight;
            // 
            // icnDecreasedParts
            // 
            ...
            icnDecreasedParts.IconSize = 60;
            icnDecreasedParts.Location = new Point(150, 10);
            icnDecreasedParts.Name = "icnDecreasedParts";
            icnDecreasedParts.Size = new Size(60, 75);
            ...
            pnlNetProfit.Location = new Point(569, 165);
            pnlNetProfit.Margin = new Padding(15);
            pnlNetProfit.Name = "pnlNetProfit";
            pnlNetProfit.Size = new Size(226, 90);
            pnlNetProfit.TabIndex = 7;
            // 
            // sabraLabel2
            // 
            ...
            lblDiedStock.TextAlign = ContentAlignment.MiddleRight;
            // 
            // iconPictureBox1
            // 
            iconPictureBox1.BackColor = Color.Transparent;
            iconPictureBox1.ForeColor = Color.DarkGoldenrod;
            iconPictureBox1.IconChar = FontAwesome.Sharp.IconChar.PauseCircle;
            iconPictureBox1.IconColor = Color.DarkGoldenrod;
            iconPictureBox1.IconFont = FontAwesome.Sharp.IconFont.Auto;
            iconPictureBox1.IconSize = 63;
            iconPictureBox1.Location = new Point(148, 10);
            iconPictureBox1.Name = "iconPictureBox1";
            iconPictureBox1.Size = new Size(63, 72);
            ...
            lblInventoryValue.TextAlign = ContentAlignment.MiddleRight;
            // 
            // icSales
            // 
            icSales.BackColor = Color.Transparent;
            icSales.ForeColor = Color.RoyalBlue;
            icSales.IconChar = FontAwesome.Sharp.IconChar.MoneyBill1Wave;
            icSales.IconColor = Color.RoyalBlue;
            icSales.IconFont = FontAwesome.Sharp.IconFont.Auto;
            icSales.IconSize = 72;
            icSales.Location = new Point(319, 10);
            icSales.Name = "icSales";
            icSales.Size = new Size(76, 72);
            ...
            dataGridViewButtonColumn2.Text = "عرض  تعديل  حركة";
            ...
            // sbtnAddPart
            // 
            sbtnAddPart.BackColor = Color.RoyalBlue;
            sbtnAddPart.BorderColor = Color.DodgerBlue;
            sbtnAddPart.BorderRadius = 20;
            sbtnAddPart.BorderSize = 0;
            sbtnAddPart.FlatAppearance.BorderSize = 0;
            sbtnAddPart.FlatStyle = FlatStyle.Flat;
            sbtnAddPart.Font = new Font("Cairo", 10F, FontStyle.Bold);
            sbtnAddPart.ForeColor = Color.White;
            sbtnAddPart.HoverColor = Color.CornflowerBlue;
            sbtnAddPart.IconChar = FontAwesome.Sharp.IconChar.None;
            sbtnAddPart.IconColor = Color.Black;
            sbtnAddPart.IconFont = FontAwesome.Sharp.IconFont.Auto;
            sbtnAddPart.Location = new Point(22, 26);
            sbtnAddPart.Name = "sbtnAddPart";
            sbtnAddPart.NormalColor = Color.RoyalBlue;
            sbtnAddPart.Size = new Size(204, 41);
        ...
        private SabraTextBox stxbxSearch;
        private SabraComboBox scbxClassification;
        private SabraButton btnSearch;
        private SabraComboBox cmbInventoryStatus;
        private SabraComboBox scbxBrand;
        private SabraButton scbtnDeleteFilters;
    }
}
